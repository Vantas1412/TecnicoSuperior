...
const EntradasEmpleadoSeccion = () => {
  ...
  useEffect(() => {
    if (!user || user.empleado?.tipo !== 'Seguridad') {
      setError('Acceso denegado: solo personal de Seguridad puede ver las entradas.');
      setLoading(false);
      return;
    }
...
export default EntradasEmpleadoSeccion;
